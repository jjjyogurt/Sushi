...
def map_analysis_response(model: AnalysisResult) -> AnalysisResponse:
    ...
    return AnalysisResponse(
        ...
        transcript_language=str(model.transcript_language or ""),
        transcript_source_language=str(model.transcript_source_language or ""),
        transcript_is_translated=bool(model.transcript_is_translated),
        transcript_translation_model=str(model.transcript_translation_model or ""),
        transcript_status=str(model.transcript_status or ""),
        transcript_error_message=str(model.transcript_error_message or ""),
